...
@Component({
  ...
  templateUrl: './history-tabs.page.html',
  styleUrls: ['./history-tabs.page.scss'],
})
export class HistoryTabsPage implements OnInit {
  ...
  statusMenu = {'1':'Proses', '2' :'Sudah Matang', '3': 'Selesai'};
